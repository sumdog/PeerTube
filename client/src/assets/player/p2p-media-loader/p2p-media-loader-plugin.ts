...
class P2pMediaLoaderPlugin extends Plugin {
  ...
  private runStats () {
    ...
    this.networkInfoInterval = setInterval(() => {
      let p2pDownloadSpeed = this.arraySum(this.statsP2PBytes.pendingDownload)
      let p2pUploadSpeed = this.arraySum(this.statsP2PBytes.pendingUpload)

      let httpDownloadSpeed = this.arraySum(this.statsHTTPBytes.pendingDownload)
      let httpUploadSpeed = this.arraySum(this.statsHTTPBytes.pendingUpload)
